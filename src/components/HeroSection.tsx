        ...
        <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-20">
          ...
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold leading-tight tracking-tighter">
              <LiquidText text="Rebel" className="block" />
              <LiquidText text="Entrepreneur" className="block" />
              <LiquidText text="Disruptor" className="block" />
              <LiquidText text="Designer" className="block" />
            </h1>
          </div>
